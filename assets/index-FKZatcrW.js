...
}`}),y({id:78,language:`JavaScript`,category:`Modules`,difficulty:`Advanced`,title:`Export Function`,description:`Named export.`,fileName:`math.js`,code:`export function add(a, b) {
  return a + b;
}`}),y({id:79,language:`JavaScript`,category:`Modules`,difficulty:`Advanced`,title:`Import Function`,description:`Named import.`,fileName:`app.js`,code:`import { add } from "./math";

console.log(add(2, 3));`}),y({id:80,language:`JavaScript`,category:`DOM`,difficulty:`Advanced`,title:`Query Selector`,description:`Select an element.`,fileName:`dom.js`,code:`const button =
  document.querySelector("button");`}),y({id:81,language:`JavaScript`,category:`DOM`,difficulty:`Advanced`,title:`Add Event Listener`,description:`Listen for clicks.`,fileName:`event.js`,code:`button.addEventListener(
  "click",
  () => {
    console.log("Clicked");
  }
);`}),y({id:82,language:`JavaScript`,category:`DOM`,difficulty:`Advanced`,title:`Change Text`,description:`Update content.`,fileName:`text.js`,code:`const heading =
  document.querySelector("h1");

heading.textContent =
  "Welcome";`}),y({id:83,language:`JavaScript`,category:`DOM`,difficulty:`Advanced`,title:`Toggle Class`,description:`Toggle a CSS class.`,fileName:`toggle.js`,code:`button.classList.toggle(
  "active"
);`}),y({id:84,language:`JavaScript`,category:`DOM`,difficulty:`Advanced`,title:`Create Element`,description:`Create a DOM node.`,fileName:`create.js`,code:`const li =
  document.createElement("li");

li.textContent = "Phillies";`}),y({id:85,language:`JavaScript`,category:`DOM`,difficulty:`Advanced`,title:`Append Child`,description:`Insert an element.`,fileName:`append.js`,code:`list.appendChild(li);`}),y({id:86,language:`JavaScript`,category:`Storage`,difficulty:`Advanced`,title:`Save Local Storage`,description:`Store data.`,fileName:`save.js`,code:`localStorage.setItem(
  "theme",
  "dark"
);`}),y({id:87,language:`JavaScript`,category:`Storage`,difficulty:`Advanced`,title:`Read Local Storage`,description:`Retrieve data.`,fileName:`read.js`,code:`const theme =
  localStorage.getItem("theme");`}),y({id:88,language:`JavaScript`,category:`Storage`,difficulty:`Advanced`,title:`Remove Local Storage`,description:`Delete data.`,fileName:`remove.js`,code:`localStorage.removeItem(
  "theme"
);`}),y({id:89,language:`JavaScript`,category:`Forms`,difficulty:`Advanced`,title:`Prevent Default`,description:`Handle a form submit.`,fileName:`form.js`,code:`form.addEventListener(
  "submit",
  (event) => {
    event.preventDefault();
  }
);`}),y({id:90,language:`JavaScript`,category:`Forms`,difficulty:`Advanced`,title:`Read Input`,description:`Get an input value.`,fileName:`input.js`,code:`const username =
  input.value;`}),y({id:91,language:`JavaScript`,category:`Fetch`,difficulty:`Advanced`,title:`POST Request`,description:`Send JSON data.`,fileName:`post.js`,code:`await fetch("/api/users", {
  method: "POST",
  headers: {
    "Content-Type": "application/json",
  },
  body: JSON.stringify(user),
});`}),y({id:92,language:`JavaScript`,category:`Async`,difficulty:`Advanced`,title:`Promise.all`,description:`Run multiple requests.`,fileName:`promiseAll.js`,code:`const results =
  await Promise.all([
    getUsers(),
    getTeams(),
  ]);`}),y({id:93,language:`JavaScript`,category:`Arrays`,difficulty:`Advanced`,title:`Flat Map`,description:`Flatten while mapping.`,fileName:`flatMap.js`,code:`const words =
  sentences.flatMap((sentence) => {
    return sentence.split(" ");
  });`}),y({id:94,language:`JavaScript`,category:`Objects`,difficulty:`Advanced`,title:`Merge Objects`,description:`Combine two objects.`,fileName:`merge.js`,code:`const settings = {
  ...defaults,
  ...userSettings,
};`}),y({id:95,language:`JavaScript`,category:`Functions`,difficulty:`Advanced`,title:`Higher Order Function`,description:`Return a function.`,fileName:`higherOrder.js`,code:`function multiply(multiplier) {
  return (number) => {
    return number * multiplier;
  };
}`}),y({id:96,language:`JavaScript`,category:`Functions`,difficulty:`Advanced`,title:`Closure`,description:`Remember outer scope.`,fileName:`closure.js`,code:`function counter() {
  let count = 0;
...
}`}),y({id:97,language:`JavaScript`,category:`Errors`,difficulty:`Advanced`,title:`Finally`,description:`Always execute cleanup.`,fileName:`finally.js`,code:`try {
  await getUsers();
} catch (error) {
  console.error(error);
} finally {
  console.log("Finished");
}`}),y({id:98,language:`JavaScript`,category:`Objects`,difficulty:`Advanced`,title:`Freeze Object`,description:`Prevent changes.`,fileName:`freeze.js`,code:`const config = {
  theme: "dark",
};

Object.freeze(config);`}),y({id:99,language:`JavaScript`,category:`Arrays`,difficulty:`Advanced`,title:`Remove Duplicates`,description:`Use a Set.`,fileName:`duplicates.js`,code:`const uniqueNumbers = [
  ...new Set(numbers),
];`}),y({id:100,language:`JavaScript`,category:`Interview`,difficulty:`Advanced`,title:`Frequency Counter`,description:`Count occurrences.`,fileName:`frequency.js`,code:`const counts = {};
...
export default App;`})],S=[y({id:2001,language:`Express`,category:`Server`,difficulty:`Beginner`,title:`Basic Server`,description:``,fileName:`server.js`,code:`import express from "express";

const app = express();

app.listen(3000, () => {
  console.log("Server listening on port 3000");
});`}),y({id:2002,language:`Express`,category:`Routes`,difficulty:`Beginner`,title:`GET Route`,description:``,fileName:`server.js`,code:`import express from "express";
...
app.listen(3000);`}),y({id:2003,language:`Express`,category:`Middleware`,difficulty:`Beginner`,title:`JSON Middleware`,description:``,fileName:`server.js`,code:`import express from "express";

const app = express();

app.use(express.json());

app.listen(3000);`}),y({id:2004,language:`Express`,category:`Routes`,difficulty:`Intermediate`,title:`Route Parameters`,description:``,fileName:`server.js`,code:`app.get("/users/:id", (req, res) => {
  const { id } = req.params;

  res.send(id);
});`}),y({id:2005,language:`Express`,category:`Routes`,difficulty:`Intermediate`,title:`POST Route`,description:``,fileName:`server.js`,code:`app.post("/users", (req, res) => {
  const user = req.body;

  res.status(201).send(user);
});`})],C=[y({id:3001,language:`HTML`,category:`Structure`,difficulty:`Beginner`,title:`Basic HTML Document`,description:``,fileName:`index.html`,code:`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
